...
async function fetchData(env) {
  ...
  if(result.msg !== '成功') {
    await sendMsgToChannel('Coupon collection failed, please check the error message and cookie.')
...
await sendMsgToChannel('Today\'s coupons are successfully collected.')
